            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        @if(Auth::user())
                            <li class="scroll-to-section"><a href="{{route('myEvents')}}">My Events</a></li>
                            <li class="scroll-to-section"><a href="{{route('myReservations')}}">My Reservations</a></li>
                            ...
                            <li class="scroll-to-section">
                                <div class="border-first-button"><a href="{{route('add_event')}}">New Event</a></div>
                            </li>
                        @else
                            <li class="scroll-to-section">
                                <div class="border-first-button"><a href="{{route('login')}}">Login/Register</a></div>
                            </li>
                        @endif
                    </ul>
